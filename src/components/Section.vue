<template>
  ...
  >
    <SectionTitle class="title" :sectionKey="sectionKey" />
...
const props = defineProps(['current', 'sectionKey']);

const section = Sections.get(props.sectionKey);
const Content = section.content;
const backgroundColor = props.current
